...
describe("large canvas media rendering", () => {
    ...
    test("keeps inactive video nodes on a viewport-gated static preview", () => {
        ...
        expect(inactivePreviewSource).toContain('<img src={localPreviewUrl}');
        expect(inactivePreviewSource).toContain('loading="lazy"');
